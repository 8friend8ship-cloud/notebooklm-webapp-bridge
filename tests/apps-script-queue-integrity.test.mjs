...
const required=[
  ['version','0.2.11-native-result-routing'],
  ...
  ['claim locked','function claimTask_(session,body){return withQueueLock_'],
  ['update locked','function updateTask_(session,body){return withQueueLock_'],
  ['complete locked','const out=withQueueLock_'],
  ['append locked','function appendTask_(task,ownerEmail){return withQueueLock_'],
  ...
  ['native receipt separation','receiptJsonFileId:file.getId()'],
  ['native pointer separation','chooseArtifactPointer_']
];
...
console.log(JSON.stringify({ok:true,action:'APPS_SCRIPT_QUEUE_INTEGRITY_STATIC',checks:required.length,noAppendRow:true,nativeReceiptSeparated:true}));
