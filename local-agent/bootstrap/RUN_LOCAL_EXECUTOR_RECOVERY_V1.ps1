...
$startedAt=Get-Date;$started=$startedAt.ToString('o');$errors=@();$installed=@{};$taskCreated=$false;$runKeySet=$false;$loopStarted=$false;$resumeExit=$null
...
if(-not$flowReceiptFresh -and $flowCanonicalOk -and (Test-Path -LiteralPath $FlowAgent -PathType Leaf)){
