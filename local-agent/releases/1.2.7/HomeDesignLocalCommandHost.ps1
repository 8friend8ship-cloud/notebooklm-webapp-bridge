...
$Patched=Join-Path $Root 'HomeDesignLocalCommandHost-1.2.7-patched.ps1'
...
$OldVersion="`$HostVersion='1.2.0'";$NewVersion="`$HostVersion='1.2.7'";if(-not $Code.Contains($OldVersion)){throw 'HOST_VERSION_PATCH_TARGET_MISSING'};$Code=$Code.Replace($OldVersion,$NewVersion)
...
$NotebookAllowNew="scripts=@('local-agent/governor/RunChromeGovernorReadback.ps1','local-agent/diagnostics/Test-NotebookLMClaimStartBridge.ps1','local-agent/governor/InspectRecentNotebookLMDownloads.ps1','local-agent/governor/MirrorNotebookLMArtifactToDrive.ps1','local-agent/governor/WatchNotebookLMDownloadsToCaptureBridge.ps1','local-agent/capture/ManageChromeExtensionArtifacts.ps1','local-agent/capture/Setup-ChromeExtensionCaptureBridge.ps1')"
