...
$Patched=Join-Path $Root 'HomeDesignLocalCommandHost-1.2.6-patched.ps1'
...
$OldVersion="`$HostVersion='1.2.0'";$NewVersion="`$HostVersion='1.2.6'";if(-not $Code.Contains($OldVersion)){throw 'HOST_VERSION_PATCH_TARGET_MISSING'};$Code=$Code.Replace($OldVersion,$NewVersion)
