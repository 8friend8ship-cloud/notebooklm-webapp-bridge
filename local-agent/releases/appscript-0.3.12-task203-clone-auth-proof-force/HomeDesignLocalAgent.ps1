...
$Version='appscript-0.3.12-task203-clone-auth-proof-force'
...
$Receipt='APPSCRIPT_TASK203_CLONE_AUTH_PROOF_FORCE_0.3.12.json'
...
try{
  ...
  $tmp=Join-Path $env:TEMP ('task203-0.3.12-child-'+(Get-Date -Format 'yyyyMMdd_HHmmss_fff')+'.ps1')
