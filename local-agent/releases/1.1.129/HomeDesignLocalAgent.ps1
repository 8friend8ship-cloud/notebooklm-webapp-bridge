...
$Runtime=Join-Path $Root 'HomeDesignLocalAgent.1.1.129.runtime.ps1'
...
try{
  ...
  $txt=$txt.Replace('1.1.117','1.1.129')
  $txt=$txt.Replace('AGENT_1.1.117_AUDIO_READY_DOWNLOAD_DRIVE_VERIFY_RESULT.json','AGENT_1.1.129_AUDIO_READY_DOWNLOAD_DRIVE_VERIFY_RESULT.json')
  $txt=$txt.Replace('AGENT_1.1.117_AUDIO_READY_DOWNLOAD_DRIVE_VERIFY','AGENT_1.1.129_AUDIO_READY_DOWNLOAD_DRIVE_VERIFY')
...
'@
  ...
  $r=[ordered]@{ok=$false;action='AGENT_1.1.129_AUDIO_READY_DOWNLOAD_DRIVE_VERIFY';version='1.1.129';stage='WRAPPER';error=$_.Exception.Message;completedAt=(Get-Date).ToString('o')}
